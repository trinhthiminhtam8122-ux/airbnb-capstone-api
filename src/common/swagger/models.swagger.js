export const swaggerSchemas = {
  ...
  BinhLuanViewModel: {
    ...
    properties: {
      ...
      noiDung: { type: "string", example: "Phòng sạch sẽ, phục vụ tốt!" },
  ...
  PhongViewModel: {
    ...
    properties: {
      id: { type: "integer", format: "int32", example: 0 },
      tenPhong: { type: "string", example: "Căn hộ Vinhomes View Sông" },
      ...
      moTa: { type: "string", example: "Căn hộ sang trọng đầy đủ tiện nghi..." },
      giaTien: { type: "integer", format: "int32", example: 1200000 },
      ...
      hinhAnh: { type: "string", example: "images/local-123456789.jpg" }
    },
  ...
  ViTriViewModel: {
    ...
    properties: {
      ...
      hinhAnh: { type: "string", example: "images/local-987654321.jpg" }
    },
